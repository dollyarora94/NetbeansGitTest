...
prodname='".$name."', price='".$price."' where id='".$id."'";
...
<script src="assignment_3.js" type="text/javascript"> </script>
...
<div id="wrapper"> 
 ...
 <!--header-starts-->
  ...
  <div class="section banner_section who_we_help">
  	<div class="container">
            <img src="images/who_we_help.jpg">
  ...
  <form action="edit_prod.php" method="POST">
      ...
      <p><input type="text" name="prodname" placeholder="" 
required value="<?php echo $row['prodname'];?>" /></p>
      
       <label> Product Price </label>
       <p><input type="text" name="price" placeholder="" 
required value="<?php echo $row['price'];?>" /></p>
       
<!--      <input type="text" type="hidden" name="name" value="<?php echo $row['id'];?>">
-->
<p align="center">
<input type="submit" name="Submit" style="background-color: #9fbc35; width:180px; height:50px" value="Update">
 </p>            
  </form>
