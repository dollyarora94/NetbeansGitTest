...
//   $filepath = $_SERVER["DOCUMENT_ROOT"]."/assignment_4/uploads/".$_FILES['img']['name'];
    ...
    $q = "INSERT INTO `products`(`prodname`,`price`,`imagetmp`,`imagename`,`prodcategory`) VALUES ('$pname','$price','$file_name','$file_name','$prodcategory')";
...
<html><head>
        ...
        <script src="http://localhost/assignment_4/js/cat_validation.js" type="text/javascript"></script>
...
//  require_once ('sqlconnection.php');
            ...
            $get = $mysqli->query("SELECT * FROM category");
                    ...
                    <div class="filable_form_container">
                        <div class="form_container_block">
                                ...
                                <form action="add_prod.php"  method="POST" enctype="multipart/form-data">
                                    <li class="fileds">
                                        <div class="name_fileds">
                                            ...
                                            <input name="prodname" type="text">  <span class="error_form" id="pname_erromsg"> </span>
                                        </div>
                                    </li>
                                    <li class="fileds">
                                        <div class="name_fileds">
                                            <label>Product Price</label>
                                            <input name="price" type="text"> <span class="error_form" id="price_erromsg"> </span>
                                        </div>
                                    </li>
                                    <li class="fileds">
                                        <div class="upload_fileds">
                                            <label>Upload Image</label>
                                            <input id="uploadFile" type="file" placeholder="Choose File" name="img" class="mandatory_fildes">
                                        </div>						
                                    </li>
                                    <li class="fileds">
                                        <div class="name_fileds">
                            ...
                            <div class="next_btn_block">
                                <div class="next_btn">
<!--                                            <a href="list_prod.php">Submit  <span><img src="css/small_triangle.png" alt="small_triangle"> </span></a>-->
                                    <input type="submit" style="background-color: #9fbc35; width:180px;height:50px; align: center" name="Submit" value="Submit">
                                    <a href="list_prod.php">List Products</a>
