...
// set table headers
                                ...
                                echo "<tr><th><input type='checkbox' id='checkAl' name='cb'></th><th>NAME</th><th>ACTION</th><th></th></tr>";
...
//echo "<td>" . $row->ACTION . "</td>";
                                    echo "<td><a href='edit_cat.php?id=" . $row->id . "'><img src='images/edit_icon.png' style='background-color: #9fbc35';></a></td>";
                                    echo "<td><a href='del.php?id=" . $row->id . "'><img src='images/delete_icon.png' style='background-color: #9fbc35';></a></td>";
                                    echo "</tr>";
                                }
...
// close database connection
                        ...
                        <!--multiple checkbox code ends here-->
