				...
				<ul>
				 ...
				 <div class="Search">
				 	...
				 	<input type="submit" class="submit" value="submit">
                                        ...
                                        <li><a href="delete_prod.php">Delete</a></li>
				</ul>
			</div>
...
// set table headers
echo "<tr><th>ID</th><th>PRODUCT NAME</th><th>PRODUCT PRICE</th><th>PRODUCT CATEGORY</th><th >ACTION</th><th></th></tr>";
...
echo "<td><a href='edit_prod.php?id=" . $row->id . "'>Edit</a></td>";
echo "<td><a href='delete_prod.php?id=" . $row->id . "'>Delete</a></td>";
echo "</tr>";
}
