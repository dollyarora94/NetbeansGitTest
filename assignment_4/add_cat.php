...
if (isset($_POST['Submit'])) {
    ...
    $cname = $_POST['name'];
    $q = "INSERT INTO `category`(`name`) VALUES ('$cname')";
...
<html><head>
    ...
    <body>
        ...
        <div id="wrapper"> 
            ...
            <!--header-ends-->
            <form action="add_cat.php" id="catform" method="POST">
                                ...
                                <ul>
                                    <li class="fileds">
                                        <div class="name_fileds">
                                            ...
                                            <input type="text" name="name" id="name" value=""> <span class="error_form" id="name_erromsg"> </span>
                                        </div>
                                    </li>
                                </ul>
                                <div class="next_btn_block">
                                    <div class="next_btn">
<!--						<a href="#" name="Submit">Submit <span><img src="css/small_triangle.png" alt="small_triangle"> </span></a>-->

                                        <input type="submit" onclick="cat_validation()" style="background-color: #9fbc35; width:180px;height:50px; align: center" name="Submit" value="Submit">
                                        <a href="list_cat.php">List Categories</a>
                                    </div>
                                </div>
                            </div>
                        </div>
